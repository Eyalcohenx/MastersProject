            ...
            <div id="guide">
                ...
                <div>
                    ...
                    <div id="info">
                        ...
                        <div>
                            <h2>Please Notice:</h2>
                            <ul>
                                <li>The winning probability of each machine is pre-fixed and does not change between rounds.</li>
                                <li>Virtual dollars you gain will award you a bonus in this HIT (10 cents for each virtual dollar).</li>
                                <li>You do not have to follow the helper’s advice but do keep in mind she does know the winning probabilities of the different machines.</li>
                                <li>The Helper gets an award each time you pick a certain machine (pre-chosen).</li>
                                <li>The HIT terminates once both dices (rolled at the end of each turn) show “6”.</li>
                            </ul>
                        </div>
                    </div>
                ...
                <form id="quiz">
                    ...
                    <label>
                        ...
                        <div><input type="radio" onChange={this.getAnswer.bind(this)} name="q1" value={2} />as many as the dice will allow me</div>
                    </label>
                    <label>
                        ...
                        <div><input type="radio" onChange={this.getAnswer.bind(this)} name="q2" value={2} />how much bonus I will get in this HIT</div>
                    </label>
                    <label>
                    ...
                    <label>
                        <span>4. What kind of Turkers do we want to participate in the game?</span>
                        <div><input type="radio" onChange={this.getAnswer.bind(this)} name="q4" value={0} />anyone</div>
                        <div><input type="radio" onChange={this.getAnswer.bind(this)} name="q4" value={1} />Turkers that seek a high bonus (they think before they act)</div>
                        <div><input type="radio" onChange={this.getAnswer.bind(this)} name="q4" value={2} />Turkers that want to gain the low reward</div>
                    </label>

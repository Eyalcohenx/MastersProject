...
// In this algorithm every turn we check if the average of the preferred arm is greater than the average of the other arms
// if it is, we advise the user to pull the preferred arm, otherwise we advise the user to pull the other arm
